    ...
    <div class="navbar navbar-default topnav">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" v-on:click="toggleNav">
                ...
                <a href="/" class="navbar-brand">
                    ...
                    <img v-bind:src="logo.src" v-bind:alt="logo.title">
                </a>
            </div>
...
<style scoped>
    .title { display: none;}
    .navbar-default .navbar-nav > .acitve > a { background: rgba(0,0,0,.03);}
</style>
