<template>
    <div class="row">
        <div class="col-md-4 col-md-offset-4 floating-box">
            ...
            <Message v-bind:show.sync="msgShow" v-bind:type="msgType" v-bind:msg="msg"/>
            <div class="panel panel-default">
                ...
                <div class="panel-body" data-validator-form>
                    ...
                    <div class="thumbnail" title="点击图片重新获取验证码" v-on:click="getCaptcha">
                        <div class="captcha vcenter" v-html="captchaTpl"></div>
                    </div>
                    <span v-on:click="register">
